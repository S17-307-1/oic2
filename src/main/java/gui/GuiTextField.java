...
public class GuiTextField extends GuiElement {
	public static final TrueTypeFont FONT = new TrueTypeFont(new Font("Verdana", Font.BOLD, 20), true);
	...
	public Rectangle2D getBoundingBox() {
		return new Rectangle2D.Double(textField.getX(), textField.getY(), textField.getWidth(), textField.getHeight());
	}
