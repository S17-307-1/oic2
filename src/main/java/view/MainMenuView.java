...
public class MainMenuView extends View {
	...
	void initContinue() {
		...
		tempButton = new Button("btn-2", "SETTINGS", 0, (int) (options.getBoundingBox().getHeight() + 10), 250);
		tempButton.setClickEvent(() -> {
			stateBasedGame.enterState(OperationIceCream.GAMEPLAY_SETTINGS);
		});
		options.addComponent(tempButton);

		tempButton = new Button("btn-3", "LEADERBOARDS", 0, (int) (options.getBoundingBox().getHeight() + 10), 250);
		tempButton.setClickEvent(() -> {
